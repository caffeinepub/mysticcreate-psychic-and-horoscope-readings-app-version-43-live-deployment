...
export default function ZodiacCalendarStrip({ isBlueTheme = false }: ZodiacCalendarStripProps) {
  ...
  return (
    <div className="w-full mb-12 px-4">
      <div className={`max-w-7xl mx-auto rounded-2xl border-2 backdrop-blur-sm p-6 transition-all duration-500 ease-in-out ${
        isBlueTheme
        ...
        {/* Title */}
        <h2 className={`text-center text-xl md:text-2xl font-bold mb-6 transition-colors duration-500 ease-in-out ${
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-4">
          {zodiacSigns.map((sign) => (
            ...
            >
              {/* Symbol */}
              <div className={`text-4xl mb-2 transition-all duration-500 ease-in-out ${
                activeSign === sign.name
                  ? isBlueTheme
              ...
              {/* Name */}
              <div className={`text-sm font-bold mb-1 transition-colors duration-500 ease-in-out ${
              ...
              {activeSign === sign.name && (
                <div className={`absolute inset-0 rounded-xl transition-opacity duration-500 ease-in-out ${
                  isBlueTheme
